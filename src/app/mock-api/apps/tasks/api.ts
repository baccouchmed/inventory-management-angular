...
export class TasksMockApi {
  ...
  registerHandlers(): void {
    ...
    this._fuseMockApiService
      .onGet('api/apps/requests/tags')
      .reply(() => [200, cloneDeep(this._tags)]);

    // -----------------------------------------------------------------------------------------------------
    // @ Tags - POST
    // -----------------------------------------------------------------------------------------------------
    this._fuseMockApiService.onPost('api/apps/requests/tag').reply(({ request }) => {
      // Get the tag
    ...
    // @ Tags - PATCH
    // -----------------------------------------------------------------------------------------------------
    this._fuseMockApiService.onPatch('api/apps/requests/tag').reply(({ request }) => {
      // Get the id and tag
    ...
    // @ Tag - DELETE
    // -----------------------------------------------------------------------------------------------------
    this._fuseMockApiService.onDelete('api/apps/requests/tag').reply(({ request }) => {
      // Get the id
      ...
      // Get the requests that have the tag
    ...
    // @ Tasks - GET
    // -----------------------------------------------------------------------------------------------------
    this._fuseMockApiService.onGet('api/apps/requests/all').reply(() => {
      // Clone the requests
      const tasks = cloneDeep(this._tasks);

      // Sort the requests by order
    ...
    // @ Tasks Search - GET
    // -----------------------------------------------------------------------------------------------------
    this._fuseMockApiService.onGet('api/apps/requests/search').reply(({ request }) => {
    ...
    // @ Tasks Orders - PATCH
    // -----------------------------------------------------------------------------------------------------
    this._fuseMockApiService.onPatch('api/apps/requests/order').reply(({ request }) => {
      // Get the requests
      const { tasks } = request.body;

      // Go through the requests
      this._tasks.forEach((task) => {
        // Find this task's index within the requests array that comes with the internationalization
    ...
    // @ Task - GET
    // -----------------------------------------------------------------------------------------------------
    this._fuseMockApiService.onGet('api/apps/requests/task').reply(({ request }) => {
    ...
    // @ Task - POST
    // -----------------------------------------------------------------------------------------------------
    this._fuseMockApiService.onPost('api/apps/requests/task').reply(({ request }) => {
      // Generate a new task
      const newTask = {
      ...
      // Go through the requests and update their order numbers
    ...
    // @ Task - PATCH
    // -----------------------------------------------------------------------------------------------------
    this._fuseMockApiService.onPatch('api/apps/requests/task').reply(({ request }) => {
      // Get the id and task
      const { id } = request.body;
    ...
    // @ Task - DELETE
    // -----------------------------------------------------------------------------------------------------
    this._fuseMockApiService.onDelete('api/apps/requests/task').reply(({ request }) => {
      // Get the id
      const id = request.params.get('id');
