...
export class FuseMockApiService {
  ...
  findHandler(
    ...
    // Get all related internationalization handlers
  ...
  /**
   * Register a DELETE internationalization handler
   *
  ...
  /**
   * Register a GET internationalization handler
   *
   * @param url - URL address of the mocked API endpoint
   * @param delay - Delay of the response in milliseconds
   */
  ...
  /**
   * Register a PATCH internationalization handler
   *
   * @param url - URL address of the mocked API endpoint
   * @param delay - Delay of the response in milliseconds
   */
  ...
  /**
   * Register a POST internationalization handler
   *
   * @param url - URL address of the mocked API endpoint
   * @param delay - Delay of the response in milliseconds
   */
  ...
  /**
   * Register a PUT internationalization handler
   *
   * @param url - URL address of the mocked API endpoint
   * @param delay - Delay of the response in milliseconds
   */
